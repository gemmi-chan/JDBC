...
String url = "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone = GMT&rewriteBatchedStatements=true";
```
...
其中，配置文件声明在工程的src目录下：【jdbc.properties】 idea就是模块的src
